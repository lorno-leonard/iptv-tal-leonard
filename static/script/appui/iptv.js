define('iptv/appui/iptv', ['antie/application', 'antie/widgets/container'], function(Application, Container) {
	return Application.extend({
		...
		run: function() {
			...
			// Create maincontainer and add a component to it
			this.addComponentContainer('maincontainer', 'iptv/appui/components/main');
		}
	});
});
