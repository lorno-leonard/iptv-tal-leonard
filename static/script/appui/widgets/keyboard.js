...
define('iptv/appui/widgets/keyboard', [
	'antie/widgets/grid',
...
], function(Grid, Button, Label, Event, KeyEvent, TextChangeEvent) {
	'use strict';
	 ...
	 *              "_" <spacer>
	 */
	var Keyboard = Grid.extend(
		/** @lends antie.widgets.Keyboard.prototype */ {
			/**
			 * @constructor
			 * @ignore
			 */
			...
			_appendCharacter: function _appendCharacter(letter) {
				...
				if (
					this._capitalisation !== Keyboard.CAPITALISATION_LOWER &&
					(this._capitalisation === Keyboard.CAPITALISATION_UPPER ||
